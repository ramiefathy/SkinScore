...
export const abcdeMelanomaTool: Tool = {
  ...
  acronym: "ABCDE",
  description: "A mnemonic for common signs of melanoma. If any are present, further evaluation is recommended. Sensitivity for melanoma is ~90%, though specificity is moderate, as many benign lesions can also fulfill some criteria.",
  condition: "Melanoma Screening",
  keywords: ["abcde", "melanoma", "skin cancer", "screening", "mole", "nevus", "early detection"],
  sourceType: 'Research',
  icon: SearchCheck,
  formSections: [
    {
      ...
      gridCols: 1, // Ensure inputs within this group are in a single column
  ...
  references: [
    "Rigel DS, et al. J Am Acad Dermatol. 1985.",
