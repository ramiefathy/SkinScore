...
export const acneQolTool: Tool = {
  ...
  description: "The Acne-QoL is a disease-specific HRQoL instrument developed to assess the impact of facial acne on adult patients. It was designed to capture the unique psychosocial and functional impairments associated with acne, which may not be adequately measured by generic or dermatology-specific tools.",
  sourceType: 'Research',
  icon: MessageSquare,
