...
export const ctcaeSkinTool: Tool = {
  ...
  acronym: "CTCAE Skin",
  description: "The CTCAE, developed by the National Cancer Institute, is the standard clinician-reported outcome measure for grading the severity of adverse events, including dermatologic toxicities, in oncology trials and practice.",
