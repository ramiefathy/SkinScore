...
export const nrsPruritusTool: Tool = {
  ...
  description: "The NRS for pruritus is a unidimensional, patient-reported outcome measure designed to quantify the intensity of itch. The rationale was to provide a simple, reliable, and valid tool for both clinical and research settings. The NRS typically asks patients to rate their itch intensity over a specified recall period (commonly the past 24 hours) on an 11-point scale from 0 (no itch) to 10 (worst imaginable itch). The NRS has demonstrated strong test-retest reliability (ICC ~0.7–0.8), high concurrent validity, and strong responsiveness to clinical change. It performs similarly to other unidimensional scales like VAS and VRS. The HOME-CP Initiative recommends its use in clinical practice. Limitations include its subjectivity, recall bias, and focus on intensity alone without capturing the multidimensional burden of itch.",
  sourceType: 'Research',
  icon: CircleDot,
  formSections: [
