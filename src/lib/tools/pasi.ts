...
export const pasiTool: Tool = {
  ...
  acronym: "PASI",
  description: "The PASI is the most widely used clinical severity scale for psoriasis, developed to provide a standardized, quantitative assessment of disease severity for use in clinical trials and practice.",
  condition: "Psoriasis / Psoriatic Arthritis",
  keywords: ["pasi", "psoriasis", "plaque psoriasis", "severity", "index", "psoriatic arthritis"],
  sourceType: 'Clinical Guideline',
  icon: Gauge,
  rationale: "The rationale for PASI was to combine both the extent of body surface area involvement and the severity of key clinical features (erythema, induration, and desquamation) into a single composite score. The PASI divides the body into four regions: head, upper limbs, trunk, and lower limbs, each weighted by its relative surface area. For each region, the area of involvement is scored from 0 to 6, and the severity of erythema, induration, and desquamation is rated from 0 (none) to 4 (maximum). The total PASI score ranges from 0 (no disease) to 72 (maximal disease).",
  clinicalPerformance: "The PASI has good internal consistency and moderate interobserver reliability. Fink et al. reported an interrater ICC of 0.895 and an intrarater ICC of 0.877 among trained physicians using image-based assessments. Automated computer-guided PASI measurements (ACPMs) have demonstrated high agreement with physician assessments (ICC 0.86) and excellent reproducibility (ICC 0.99), outperforming physicians for intrarater reliability. The PASI is most reliable when used by trained clinicians, but reliability decreases in routine practice due to subjectivity and variability in scoring. Sensitivity and specificity are not typically reported for PASI, as it is a continuous severity index rather than a diagnostic tool. Its primary psychometric strengths are good internal consistency, moderate to high inter- and intrarater reliability among trained users, and moderate sensitivity to clinical change.",
