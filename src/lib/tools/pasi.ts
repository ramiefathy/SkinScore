...
export const pasiTool: Tool = {
  ...
  acronym: "PASI",
  description: "The PASI is the most widely used clinical severity scale for psoriasis, developed to provide a standardized, quantitative assessment of disease severity for use in clinical trials and practice. The rationale for PASI was to combine both the extent of body surface area involvement and the severity of key clinical features (erythema, induration, and desquamation) into a single composite score. The PASI divides the body into four regions: head, upper limbs, trunk, and lower limbs, each weighted by its relative surface area. For each region, the area of involvement is scored from 0 to 6, and the severity of erythema, induration, and desquamation is rated from 0 (none) to 4 (maximum). The PASI score is calculated as: PASI = 0.1*(EH+IH+DH)*AH + 0.2*(EU+IU+DU)*AU + 0.3*(ET+IT+DT)*AT + 0.4*(EL+IL+DL)*AL. The total PASI score ranges from 0 (no disease) to 72 (maximal disease). The PASI has good internal consistency and moderate interobserver reliability (ICC ~0.895 among trained physicians). Its main limitations include interobserver variability in routine practice, complex calculation, and low responsiveness in mild disease. Strategies to improve reliability include structured training and automation.",
