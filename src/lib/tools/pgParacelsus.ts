...
export const pgParacelsusTool: Tool = {
  ...
  description: "The PARACELSUS Score was developed to address the diagnostic challenge of pyoderma gangrenosum (PG), a rare neutrophilic dermatosis that lacks objective diagnostic criteria and is often a diagnosis of exclusion. The rationale was to create a comprehensive, sensitive, and clinically practical tool to differentiate PG from other ulcerative conditions. The score comprises 10 criteria, divided into major (3 points), minor (2 points), and additional (1 point) categories. A total score of 10 or higher indicates a high likelihood of PG. In its original validation, the score demonstrated high sensitivity and specificity for distinguishing PG from venous leg ulcers. However, reliability metrics like interobserver agreement are not explicitly reported, and further prospective validation studies are needed. Its limitations include subjectivity in assessing certain criteria and limited generalizability to non-specialist settings.",
