...
const pgSuFormSections: FormSectionConfig[] = [
  {
    ...
    inputs: [
      ...
      { id: "pg_su_major_biopsy_neutrophil", label: "Other major criteria for PG excluded by biopsy (infection, vasculitis, malignancy)", type: 'select', options: commonYesNoOptions, defaultValue: 0, validation: getValidationSchema('select', commonYesNoOptions, 0, 1) }
    ]
  },
  {
