...
export const uas7Tool: Tool = {
  ...
  description: "The UAS7 is a validated, patient-reported outcome measure designed to quantify disease activity in chronic urticaria, particularly chronic spontaneous urticaria (CSU). It was developed to provide a standardized, objective, and reproducible measure of urticaria severity, facilitating disease monitoring, treatment decisions, and outcome assessment in both clinical trials and routine practice.",
  sourceType: 'Research',
  icon: Calendar,
  rationale: "The UAS7 is calculated as the sum of daily urticaria activity scores over seven consecutive days. Each day's score is composed of two subscores:\n• Number of wheals (0–3): 0 = none, 1 = <20, 2 = 20–50, 3 = >50 or large confluent areas.\n• Intensity of pruritus (0–3): 0 = none, 1 = mild, 2 = moderate, 3 = severe.\nThe daily score (0–6) is summed over seven days, yielding a total score from 0 to 42. Higher scores indicate greater disease activity. The UAS7 can be calculated using once-daily or twice-daily diaries, with both versions demonstrating high correlation and similar clinical utility.",
  clinicalPerformance: "The UAS7 is endorsed by the American Academy of Dermatology and the European Academy of Allergy and Clinical Immunology (EAACI) as the gold standard for urticaria activity assessment. Multiple studies have demonstrated its robust psychometric properties:\n• Internal consistency: Cronbach's alpha 0.83 (Spanish version).\n• Test-retest reliability: Intraclass correlation coefficient (ICC) 0.84.\n• Convergent validity: Strong correlations with quality of life measures (EQ-5D, CU-QoL).\n• Responsiveness: Effect sizes up to 1.52 for changes in disease status.\n• Minimal important difference (MID): 7–8 points on a 0–42 scale.\n• Sensitivity and specificity: Not directly reported as a diagnostic tool, but categorical UAS7 states (none, mild, moderate, severe) accurately predict differences in patient-reported outcomes and treatment response.\nComparative studies have shown that once-daily and twice-daily UAS7 versions are highly consistent (correlation coefficients >0.94, weighted kappa 0.78–0.82). The UAS7 is less burdensome than alternative versions and is recommended for routine use.",
  formSections:
  ...
  calculationLogic: (inputs) => {
      ...
      interpretation += " (Guideline severity bands: 0-6 None, 7-15 Mild, 16-27 Moderate, 28-42 Severe)";
  ...
  references: [
    ...
    "Mathias SD, Crosby RD, Zazzali JL, Maurer M, Saini SS. Evaluating the Minimally Important Difference of the Urticaria Activity Score and Other Measures of Disease Activity in Patients With Chronic Idiopathic Urticaria. Annals of Allergy, Asthma & Immunology : Official Publication of the American College of Allergy, Asthma, & Immunology. 2012;108(1):20-24. doi:10.1016/j.anai.2011.09.008.",
